  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="min-h-[2.5rem] flex-1 resize-none rounded-xl border border-line bg-surface px-3 py-2 text-sm text-ink placeholder:text-ink-muted focus-visible:border-accent disabled:opacity-60"
      />
      {busy ? (
        <button
          type="button"
